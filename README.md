...
/*This query shows the number of trips taken by each bike every day, and is shown on the administrator dashboard  */
SELECT bike_number, count(bike_number) FROM trips WHERE start_date = CURDATE();
